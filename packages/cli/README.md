...
| `--remote-refs <mode>`                        | resolve / check / validate / compile-spec / stream-check | How far `http(s)` reads may go, **the entry document included**: `allow` (default), `same-origin`, `deny`. See [docs/configuration.md](../../docs/configuration.md#resolving-untrusted-specs).                                                                                                                                              |
