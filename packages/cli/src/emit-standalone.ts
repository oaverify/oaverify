...
export function emitStandalone(schema: SchemaOrBoolean, options: EmitStandaloneOptions): string {
  ...
  return [
    "// Generated by the oaverify CLI's `compile` command. Do not edit by hand.",
    "// Regenerate by running `oaverify compile <schema>` against the source schema.",
    "",
 ...
 * runtime side of `@oaverify/internal-schema`'s `createDeps`; if that list ever
