 ...
 *
 * Exported through `@oaverify/internal-validator/internals` so `oav compile-spec`'s
 ...
 *
 * Exported through `@oaverify/internal-validator/internals` for the `oav compile-spec`
